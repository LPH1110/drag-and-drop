...
function DatePicker() {
    ...
    return (
        <div className="w-full">
            <div className="max-w-md text-lg p-4 mx-auto sm:px-7 md:max-w-4xl md:px-6">
                <div className="">
                    ...
                    <div className="grid grid-cols-7 mt-10 text-sm leading-6 text-center text-gray-400">
                        <div>S</div>
                        <div>M</div>
                        <div>T</div>
                        <div>W</div>
                            ...
                            >
                                <button
                                    ...
                                    className={classNames(
                                        ...
                                        'mx-auto flex h-8 w-8 items-center justify-center rounded-full ease duration-200',
                                    )}
                                >
